...
import com.example.hubiottest.screens.common.dialogs.BaseDialog;
...
public class PromptDialog extends BaseDialog implements PromptViewMvc.Listener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mDialogsEventBus = getControllerCompositionRoot().getDialogsEventBus();
    }
    ...
    public final Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mViewMvc = getControllerCompositionRoot().getViewMvcFactory().getPromptViewMvc(null);
    ...
    public void onPositiveButtonClicked() {
        dismiss();
        mDialogsEventBus.postEvent(new PromptDialogEvent(PromptDialogEvent.Button.POSITIVE), null);
    }

    @Override
    public void onNegativeButtonClicked() {
        dismiss();
        mDialogsEventBus.postEvent(new PromptDialogEvent(PromptDialogEvent.Button.NEGATIVE), null);
    }
